...
export class OrderCommitted extends Entity {
  ...
  static loadInBlock(id: string): OrderCommitted | null {
    return changetype<OrderCommitted | null>(
      store.get_in_block("OrderCommitted", id),
    );
  }
...
export class OrderSettled extends Entity {
  ...
  static loadInBlock(id: string): OrderSettled | null {
    return changetype<OrderSettled | null>(
      store.get_in_block("OrderSettled", id),
    );
  }
...
export class PreviousOrderExpired extends Entity {
  ...
  static loadInBlock(id: string): PreviousOrderExpired | null {
    return changetype<PreviousOrderExpired | null>(
      store.get_in_block("PreviousOrderExpired", id),
    );
  }

  static load(id: string): PreviousOrderExpired | null {
    return changetype<PreviousOrderExpired | null>(
      store.get("PreviousOrderExpired", id),
    );
  }
