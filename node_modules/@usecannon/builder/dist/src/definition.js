...
exports.ChainDefinition = exports.validatePackageVersion = exports.validatePackageName = void 0;
...
class ChainDefinition {
        ...
        for (const [action, data] of Object.entries(actionsDef)) {
            for (const name of Object.keys(data)) {
                ...
                if (actions_1.ActionKinds[action] && actions_1.ActionKinds[action].getOutputs) {
                    for (const output of actions_1.ActionKinds[action].getOutputs(lodash_1.default.get(def, fullActionName), {
    ...
    getConfig(n, ctx) {
        ...
        (0, actions_1.validateConfig)(actions_1.ActionKinds[kind].validate, lodash_1.default.get(this.raw, n));
        return actions_1.ActionKinds[n.split('.')[0]].configInject({ ...ctx, ...types_1.CannonHelperContext }, lodash_1.default.get(this.raw, n), {
