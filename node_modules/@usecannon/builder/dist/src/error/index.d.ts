...
export declare function traceActions(artifacts: ChainArtifacts): (client: viem.Client) => {
    ...
    prepareTransactionRequest: (args: viem.PrepareTransactionRequestParameters) => Promise<{
        ...
        account: {
            ...
            } | undefined) => Promise<import("viem/_types/types/utils").IsNarrowable<viem.TransactionSerialized<viem.GetTransactionType<transaction>>, `0x${string}`> extends true ? viem.TransactionSerialized<viem.GetTransactionType<transaction>> : `0x${string}`>;
            signTypedData: <const typedData extends Record<string, unknown> | {
                ...
                uint248?: undefined;
                uint256?: undefined;
            }, primaryType extends "EIP712Domain" | keyof typedData = keyof typedData>(typedDataDefinition: viem.TypedDataDefinition<typedData, primaryType>) => Promise<`0x${string}`>;
            publicKey: `0x${string}`;
            source: string;
            type: "local";
        };
