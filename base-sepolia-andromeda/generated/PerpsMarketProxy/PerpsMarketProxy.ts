...
export class AccountFlaggedForLiquidation extends ethereum.Event {
  get params(): AccountFlaggedForLiquidation__Params {
    return new AccountFlaggedForLiquidation__Params(this);
  }
}

export class AccountFlaggedForLiquidation__Params {
  _event: AccountFlaggedForLiquidation;

  constructor(event: AccountFlaggedForLiquidation) {
    this._event = event;
  }
...
export class PerpsMarketProxy__commitOrderResultRetOrderStruct extends ethereum.Tuple {
  ...
  get request(): PerpsMarketProxy__commitOrderResultRetOrderRequestStruct {
    return changetype<PerpsMarketProxy__commitOrderResultRetOrderRequestStruct>(
      this[1].toTuple(),
    );
  }
}
...
export class PerpsMarketProxy__getOrderResultOrderStruct extends ethereum.Tuple {
  ...
  get request(): PerpsMarketProxy__getOrderResultOrderRequestStruct {
    return changetype<PerpsMarketProxy__getOrderResultOrderRequestStruct>(
      this[1].toTuple(),
    );
  }
}
...
export class PerpsMarketProxy extends ethereum.SmartContract {
  ...
  createMarket(
    ...
    let result = super.call(
      "createMarket",
      "createMarket(uint128,string,string):(uint128)",
      [
  ...
  getOpenPositionSize(accountId: BigInt, marketId: BigInt): BigInt {
    let result = super.call(
      "getOpenPositionSize",
      "getOpenPositionSize(uint128,uint128):(int128)",
      [
        ethereum.Value.fromUnsignedBigInt(accountId),
        ethereum.Value.fromUnsignedBigInt(marketId),
      ],
  ...
  getRequiredMargins(
    accountId: BigInt,
  ): PerpsMarketProxy__getRequiredMarginsResult {
    let result = super.call(
      "getRequiredMargins",
  ...
  getWithdrawableMargin(accountId: BigInt): BigInt {
    let result = super.call(
      ...
      "getWithdrawableMargin(uint128):(int256)",
      [ethereum.Value.fromUnsignedBigInt(accountId)],
    );
  ...
  fillPrice(marketId: BigInt, orderSize: BigInt, price: BigInt): BigInt {
    let result = super.call(
      "fillPrice",
      "fillPrice(uint128,int128,uint256):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(marketId),
  ...
  metadata(marketId: BigInt): PerpsMarketProxy__metadataResult {
    ...
    return new PerpsMarketProxy__metadataResult(
      result[0].toString(),
      result[1].toString(),
    );
  }
  ...
  try_metadata(
    marketId: BigInt,
  ): ethereum.CallResult<PerpsMarketProxy__metadataResult> {
    let result = super.tryCall(
      "metadata",
      "metadata(uint128):(string,string)",
      [ethereum.Value.fromUnsignedBigInt(marketId)],
    );
    if (result.reverted) {
      return new ethereum.CallResult();
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PerpsMarketProxy__metadataResult(
        value[0].toString(),
        value[1].toString(),
      ),
    );
  ...
  computeOrderFees(
    marketId: BigInt,
    sizeDelta: BigInt,
  ): PerpsMarketProxy__computeOrderFeesResult {
    let result = super.call(
      "computeOrderFees",
    ...
    return new PerpsMarketProxy__computeOrderFeesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_computeOrderFees(
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PerpsMarketProxy__computeOrderFeesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
  ...
  getOrder(accountId: BigInt): PerpsMarketProxy__getOrderResultOrderStruct {
    ...
    return changetype<PerpsMarketProxy__getOrderResultOrderStruct>(
      result[0].toTuple(),
    );
  }
  ...
  try_getOrder(
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<PerpsMarketProxy__getOrderResultOrderStruct>(
        value[0].toTuple(),
      ),
    );
  }
  ...
  getSettlementRewardCost(
    ...
    let result = super.call(
      "getSettlementRewardCost",
      "getSettlementRewardCost(uint128,uint128):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(marketId),
  ...
  liquidateFlagged(maxNumberOfAccounts: BigInt): BigInt {
    let result = super.call(
      "liquidateFlagged",
      "liquidateFlagged(uint256):(uint256)",
  ...
  try_liquidateFlagged(
    maxNumberOfAccounts: BigInt,
  ): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "liquidateFlagged",
      "liquidateFlagged(uint256):(uint256)",
  ...
  try_liquidateFlaggedAccounts(
    accountIds: Array<BigInt>,
  ): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "liquidateFlaggedAccounts",
      "liquidateFlaggedAccounts(uint128[]):(uint256)",
  ...
  liquidationCapacity(
    marketId: BigInt,
  ): PerpsMarketProxy__liquidationCapacityResult {
    let result = super.call(
      "liquidationCapacity",
  ...
  getLockedOiRatio(marketId: BigInt): BigInt {
    let result = super.call(
      "getLockedOiRatio",
      "getLockedOiRatio(uint128):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(marketId)],
    );
  ...
  getMaxMarketSize(marketId: BigInt): BigInt {
    let result = super.call(
      "getMaxMarketSize",
      "getMaxMarketSize(uint128):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(marketId)],
    );
  ...
  getPriceData(perpsMarketId: BigInt): PerpsMarketProxy__getPriceDataResult {
    let result = super.call(
      "getPriceData",
      "getPriceData(uint128):(bytes32,uint256)",
      [ethereum.Value.fromUnsignedBigInt(perpsMarketId)],
    );

    return new PerpsMarketProxy__getPriceDataResult(
      result[0].toBytes(),
      result[1].toBigInt(),
    );
  }
  ...
  try_getPriceData(
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PerpsMarketProxy__getPriceDataResult(
        value[0].toBytes(),
        value[1].toBigInt(),
      ),
    );
  ...
  getPerAccountCaps(): PerpsMarketProxy__getPerAccountCapsResult {
    let result = super.call(
      "getPerAccountCaps",
      "getPerAccountCaps():(uint128,uint128)",
      [],
    );
  ...
  try_getPerAccountCaps(): ethereum.CallResult<PerpsMarketProxy__getPerAccountCapsResult> {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PerpsMarketProxy__getPerAccountCapsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
  ...
  getReferrerShare(referrer: Address): BigInt {
    let result = super.call(
      "getReferrerShare",
      "getReferrerShare(address):(uint256)",
